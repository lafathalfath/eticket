    ...
    <div class="p-3">
        ...
        <div class="row">
            <div class="col-lg-9">
                ...
                <div class="row">
                    <div class="col-12">
                        <button class="btn btn-success mt-2"><i class="fas fa-thumbs-up"></i> Sangat Membantu</button>
                    </div>
                </div>
                <hr>
            </div>
            <div class="col-lg-3">
                <div class="aler alert-info p-3 rounded" role="alert">
                    ...
                    <hr>                                        
                    <button class="btn btn-primary"><i class="fas fa-ticket-alt"></i> Buka Tiket</button>
                </div>
            </div>
        </div>
        <?php endforeach; ?>   
