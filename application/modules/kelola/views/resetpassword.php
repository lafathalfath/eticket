                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" id="password_baru" placeholder="Password Baru">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" id="konfirmasi_password" placeholder="Konfirmasi Password Baru">
                                        </div>
                                        <a href="<?= base_url('masuk') ?>" class="btn btn-primary btn-user btn-block">
                                            Ganti Password
                                        </a>
                                    </form>
                                </div>
