<div class="container-lg bg-white mt-4 rounded" data-aos="fade-up">
    <div class="p-5">
    <?= form_open('pengguna/form/fsid3301_save', ['id' => 'frm-submit-fsid3301']) ?>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="form-group">
                        <label class="font-weight-bold" for="usulan_email">Alamat Email Yang Diusulkan<span class="font-weight-bold text-danger">*</span></label>
                        <input class="form-control" type="text" name="usulan_email" id="usulan_email" placeholder="Contoh: pengguna@bsn.go.id">
                    </div>
                </div>
            </div>
            <div class="row">
