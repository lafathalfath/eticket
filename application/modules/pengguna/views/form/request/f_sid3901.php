<div class="container-lg bg-white mt-4 rounded" data-aos="fade-up">
    <div class="p-5">
    <?= form_open('pengguna/form/fsid3901_save', ['id' => 'frm-submit-fsid3901']) ?>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                  <div class="form-group">
                      <label class="font-weight-bold" for="nama_aplikasi">Nama Barang<span class="font-weight-bold text-danger">*</span></label>
                      <input class="form-control" type="text" name="nama_barang" id="nama_barang" placeholder="Masukkan Nama Barang">
                  </div>
                  <div class="form-group">
                      <label class="font-weight-bold" for="nama_aplikasi">Merk Produk<span class="font-weight-bold text-danger">*</span></label>
                      <input class="form-control" type="text" name="merk_produk" id="merk_produk" placeholder="Masukkan Merk Produk">
                  </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="form-group">
                        <label class="font-weight-bold" for="nomor_seri">Nomor Seri<span class="font-weight-bold text-danger">*</span></label>
                        <input class="form-control" type="text" name="nomor_seri" id="nomor_seri" placeholder="Masukkan Nomor Seri">
                    </div>

                    <div class="form-group">
                        <label class="font-weight-bold" for="keterangan">Keterangan<span class="font-weight-bold text-danger">*</span></label>
                        <textarea class="form-control" name="keterangan" id="keterangan" cols="30" rows="5" placeholder="Masukan keterangan terkait penggunaan storage"></textarea>
                    </div>
                </div>
            </div>
            <div class="row">
