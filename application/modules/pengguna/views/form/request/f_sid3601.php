<div class="container-lg bg-white mt-4 rounded" data-aos="fade-up">
    <div class="p-5">
    <?= form_open('pengguna/form/fsid3601_save', ['id' => 'frm-submit-fsid3601']) ?>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="form-group">
                        <label class="font-weight-bold" for="jenis_data">Jenis Data<span class="font-weight-bold text-danger">*</span></label>
                        <input class="form-control" type="text" name="jenis_data" id="jenis_data" placeholder="Jelaskan data yang anda minta">
                    </div>
                </div>
            </div>
            <div class="row">
