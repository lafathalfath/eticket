...
-- Dumping data for table db_eticketing.m_jenis_layanan: ~4 rows (approximately)
DELETE FROM `m_jenis_layanan`;
/*!40000 ALTER TABLE `m_jenis_layanan` DISABLE KEYS */;
INSERT INTO `m_jenis_layanan` (`id`, `kategori_id`, `jenis_layanan`) VALUES
	(1, 2, 'Website'),
	(2, 2, 'Software Tools'),
	(3, 1, 'Hardware tech'),
	(4, 3, 'Email');
...
CREATE TABLE IF NOT EXISTS `m_kategori_layanan` (
  ...
  `Kategori_layanan` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

-- Dumping data for table db_eticketing.m_kategori_layanan: ~3 rows (approximately)
DELETE FROM `m_kategori_layanan`;
/*!40000 ALTER TABLE `m_kategori_layanan` DISABLE KEYS */;
INSERT INTO `m_kategori_layanan` (`id`, `klasifikasi_id`, `Kategori_layanan`) VALUES
	(1, 1, 'Perangkat Keras'),
	(2, 1, 'Perangkat Lunak'),
	(3, 1, 'Network');
...
DELETE FROM `m_klasifikasi`;
/*!40000 ALTER TABLE `m_klasifikasi` DISABLE KEYS */;
INSERT INTO `m_klasifikasi` (`id`, `klasifikasi`) VALUES
	(1, 'Perbaikan'),
	(2, 'permintaan Baru');
...
-- Dumping data for table db_eticketing.m_ruang_rapat: ~0 rows (approximately)
DELETE FROM `m_ruang_rapat`;
...
CREATE TABLE IF NOT EXISTS `m_status` (
  ...
  `status` varchar(10050) DEFAULT NULL,
...
-- Dumping data for table db_eticketing.m_web: ~2 rows (approximately)
DELETE FROM `m_web`;
...
CREATE TABLE IF NOT EXISTS `ticket` (
  ...
  `tr_layanan_id` int(4) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tr_jawaban` (
  ...
  `faq_id` int(20) unsigned zerofill DEFAULT NULL,
  `jawaban` int(20) DEFAULT NULL COMMENT 'is faq fill, jabawan null. is faq null, jawaban must be filled',
...
DELETE FROM `tr_layanan`;
/*!40000 ALTER TABLE `tr_layanan` DISABLE KEYS */;
INSERT INTO `tr_layanan` (`id`, `jenis_id`, `sub_id`, `keterangan`) VALUES
	(1, 3, 1, 'printer'),
	(2, 3, 2, 'Pc'),
