...
-- Dumping database structure for db_eticketing
CREATE DATABASE IF NOT EXISTS `db_eticketing` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `db_eticketing`;
...
-- Dumping data for table db_eticketing.m_kategori_layanan: ~4 rows (approximately)
...
INSERT INTO `tr_layanan` (`id`, `jenis_id`, `sub_id`, `bidang_id`, `keterangan`) VALUES
	(1, 3, 1, NULL, 'printer'),
	(2, 3, 2, NULL, 'Pc'),
	(3, 2, 1, NULL, 'Microsoft Office'),
	(4, 1, 1, NULL, 'Web BSN');
